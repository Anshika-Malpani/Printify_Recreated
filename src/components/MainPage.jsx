        ...
        <div className='w-full '>
            <div className='w-full h-[95vh] flex flex-col md:flex-row items-center md:justify-evenly px-10'>
                ...
                <div className='w-full h-[60%] md:w-[50%] md:h-full flex items-center relative'>
                    ...
                    <img ref={print3} className='print3 absolute w-[30%] md:w-[22%] left-[72%] md:left-[70%] top-[56%] md:top-[22rem]' src="print3.png" alt="" />
                    <img ref={print4} className='print4 absolute w-[30%] md:w-[22%] left-[70%] md:left-[72%] top-[6%] md:top-[5rem]' src="print6.png" alt="" />
                </div>
            </div>
        </div>
    )
